...
export default function SimpletvScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{position: 'relative', marginTop: 'auto'}}>
        <Pressable onPress={showModal} disabled={selectedCurrency !== '' && BsAmount !== '' && phoneNumber !== '' ? false : true}> 
            {({pressed}) => (
              <View style={[selectedCurrency !== '' && BsAmount !== '' && phoneNumber !== '' ? pressed? {backgroundColor: '#048EA9'} : {backgroundColor: '#00B4D8'} : {backgroundColor: 'lightgray'} , styles.rechargeButton]}>
