import {
  ...
  export default function RetiroPagoMovilScreen() {
    ...
    return (
      <SafeAreaView style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollView}>
          <Text style={{fontSize: 18, marginBottom: 0}}>Retirar a través de Pago Móvil</Text>
          {/* <LinearGradient
            ...
            <Pressable > 
                {({pressed}) => (
                  <View style={[pressed? {backgroundColor: '#048EA9'} : {backgroundColor: '#00B4D8'}, styles.rechargeButton]}>
                    <Text style={{color: 'white', fontSize: 14, fontWeight: 'bold'}}>Retirar</Text>
                  </View>
              )}
            </Pressable>
            <Pressable > 
