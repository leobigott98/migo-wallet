import {
  ...
  export default function PagoMovilC2PScreen() {
    ...
    return (
      <SafeAreaView style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollView}>
          <Text style={{fontSize: 18, marginBottom: 0}}>Recargar con Pago Móvil C2P</Text>
          {/* <LinearGradient
        ...
        />
            ...
            <View>
              ...
              <TextInput style={styles.input} placeholder="Clave de Pago (OTP)" placeholderTextColor='gray' inputMode="numeric"/>
            </View>
            <View>
              <Text style={[styles.inputLabel, {marginVertical: 5}]} >Monto a recargar (Bs)</Text>
            ...
            <Pressable > 
                {({pressed}) => (
                  <View style={[pressed? {backgroundColor: '#048EA9'} : {backgroundColor: '#00B4D8'}, styles.rechargeButton]}>
                    <Text style={{color: 'white', fontSize: 14, fontWeight: 'bold'}}>Recargar</Text>
                  </View>
              )}
            </Pressable>
            <Pressable > 
